...
static const CGFloat kFontSizeLarge = 1;
static const CGFloat kFontSizeMedium = 0.9;
static const CGFloat kFontSizeSmall = 0.75;
...
- (void)viewDidLoad
{
    ...
    CGFloat fontSize = [prefs floatForKey:kFontSizeKey];
