...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.cellSize = CGSizeMake(frame.size.width, cellHeight);
        ...
        self.timeLabel = [[UILabel alloc] initWithFrame:CGRectMake(xPadding, cellHeight - 10 - yPadding, self.cellSize.width - 2*xPadding, 20)];
        ...
        self.titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(xPadding, self.timeLabel.frame.origin.y - titleLabelHeight, self.cellSize.width - 2*xPadding, titleLabelHeight)];
